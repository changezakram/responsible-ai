...
**3. Keep Improving Through Research:** Many open questions remain around fairness, alignment, evaluation, and long-term behavior. Post-training techniques — including instruction tuning, RLHF, and constitutional AI — are among the primary tools for teaching models to refuse harmful requests and align outputs with safety requirements. Interpretability tooling and red-teaming remain open research problems. For a technical overview of how models are shaped after initial training, see [Post Training](https://changezakram.github.io/Deep-Generative-Models/post-training.html).
