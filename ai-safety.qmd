...
These definitions frequently conflict with one another. Improving one fairness metric can worsen another. For example, equalizing false positive rates may increase false negative disparities, while enforcing equal selection rates can reduce predictive accuracy.
