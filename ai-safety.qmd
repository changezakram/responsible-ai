...
Choosing a fairness definition is not a technical decision — it is an institutional one with legal consequences. Equalizing false positive rates across demographic groups may satisfy equalized odds but violate demographic parity. Optimizing for one standard can actively worsen another. Banks cannot outsource that choice to a model.
