...
## Governing the System, Not Just the Model
...
![**The Continuous Governance Loop.** Audit and learning close the loop rather than ending it. As institutions define objectives, authorize agents, execute, observe outcomes, intervene when needed, and learn from what happened, those findings feed directly back into refining policy — closing the cycle rather than treating governance as a one-time approval.](images/governance-cycle.png){#fig-governance-cycle fig-align="center" width="50%"}
...
[1] Board of Governors of the Federal Reserve System, Office of the Comptroller of the Currency, & Federal Deposit Insurance Corporation. (2026). "Revised Guidance on Model Risk Management (SR 26-2)." https://www.federalreserve.gov/supervisionreg/srletters/SR2602.htm

[2] Financial Stability Board. (2026). "Sound Practices for Responsible Adoption of Artificial Intelligence (AI): Consultation Report." https://www.fsb.org/2026/06/sound-practices-for-responsible-adoption-of-artificial-intelligence-ai-consultation-report/

[3] National Institute of Standards and Technology (NIST). (2024). "Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile (AI RMF GenAI Profile)." https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.600-1.pdf

[4] Anthropic. (2023). "Constitutional AI: Harmlessness from AI Feedback." https://arxiv.org/pdf/2212.08073

[5] Fortune. (2025). "An AI-powered coding tool wiped out a software company’s database" https://fortune.com/2025/07/23/ai-coding-tool-replit-wiped-database-called-it-a-catastrophic-failure/

[6] Krakovna, V., Uesato, J., Mikulik, V., Everitt, T., et al. (2020). "Specification Gaming: The Flip Side of AI Ingenuity." https://deepmind.google/discover/blog/specification-gaming-the-flip-side-of-ai-ingenuity/
