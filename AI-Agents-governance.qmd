...
![AI governance should be proportional to both an agent's autonomy and the consequences of its actions. As either dimension increases, stronger governance, oversight, and runtime controls become essential.](images/ai-governance-matrix.png){#fig-ai-governance-matrix fig-alt="Risk-based governance framework for agentic AI illustrating governance requirements across varying levels of autonomy and business consequences."}
