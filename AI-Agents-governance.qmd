...
Before a material agent receives production authority, the institution should establish a governance contract defining the agent’s approved purpose, objectives, permitted data, tools, systems, and actions not only expected scenariosit may access, prohibited activities, human-escalation requirements, monitoring expectations, the conditions under which its authority may be reduced or suspended, and the accountable business owner. This converts broad governance principles into explicit operating expectations.
...
The objective is not only to understand how the system fails, but whether the controls fail safely when it does. For higher-risk systems, scenario and adversarial testing should become part of the approval process.
