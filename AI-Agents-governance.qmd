...
Even when an agent operates entirely within its authorized permissions, its behavior may gradually diverge from institutional expectations. Governing that behavior is the next challenge.
...
Behavioral assurance extends traditional model monitoring: confidence that an AI system remains technically effective, and confidence that its ongoing actions stay aligned with its approved purpose, authority, and risk boundaries. 

An agent also interacts with data, tools, APIs, memory, and other agents in ways that can create risks no individual component would produce on its own. Those interactions introduce a different governance challenge: ensuring the complete system remains safe, not just its individual components.
...
Composition governance extends traditional component assurance into system assurance. The objective is not simply to confirm that each individual component operates correctly, but that the complete agentic system continues to behave safely when those components interact.

As agentic AI becomes more widely adopted, governance extends beyond individual systems to the resilience of the broader financial ecosystem. Institutions may deploy similar agents, rely on common providers, and respond to the same market signals, creating risks that emerge only at scale.
...
Banks do not need to move directly from copilots to fully autonomous systems. A more effective approach expands autonomy as evidence accumulates.
...
Financial institutions have spent decades building governance frameworks for models, data, technology, cybersecurity, and operational risk. Those disciplines remain essential, but agentic AI changes the unit of governance. As AI systems gain the ability to reason, use tools, and take actions, institutions must govern the autonomous decision-making system the model operates within, not just the model itself.

This piece argues that Responsible AI should evolve beyond traditional model governance through five complementary governance dimensions: **Objective, Authority, Behavior, Composition, and Systemic Governance**. Together, they extend governance from evaluating model performance to managing the behavior, authority, interactions, and resilience of autonomous systems.
...
[1] National Institute of Standards and Technology (NIST). (2024). "Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile (AI RMF GenAI Profile)." https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.600-1.pdf

[2] International Organization for Standardization (ISO). (2023). "ISO/IEC 42001:2023 – Information Technology — Artificial Intelligence — Management System." https://www.iso.org/standard/81230.html

[3] Amodei, D., Olah, C., Steinhardt, J., Christiano, P., Schulman, J., & Mané, D. (2016). "Concrete Problems in AI Safety." https://arxiv.org/pdf/1606.06565

[4] Yao, S., Zhao, J., Yu, D., Du, N., Shafran, I., Narasimhan, K., & Cao, Y. (2023). "ReAct: Synergizing Reasoning and Acting in Language Models." https://arxiv.org/pdf/2210.03629

[5] Board of Governors of the Federal Reserve System, Office of the Comptroller of the Currency, & Federal Deposit Insurance Corporation. (2026). "Revised Guidance on Model Risk Management (SR 26-2)." https://www.federalreserve.gov/supervisionreg/srletters/SR2602.htm

[6] Financial Stability Board. (2026). "Sound Practices for Responsible Adoption of Artificial Intelligence (AI): Consultation Report." https://www.fsb.org/2026/06/sound-practices-for-responsible-adoption-of-artificial-intelligence-ai-consultation-report/

[7] Anthropic. (2023). "Constitutional AI: Harmlessness from AI Feedback." https://arxiv.org/pdf/2212.08073

[8] Google DeepMind. (2024). "An Approach to Technical AGI Safety and Security." https://arxiv.org/pdf/2407.14972

[9] Replit. (2025). "Incident Report: AI Coding Agent Production Database Deletion." (Official Replit engineering blog or incident report.)

[10] Krakovna, V., Uesato, J., Mikulik, V., Everitt, T., et al. (2020). "Specification Gaming: The Flip Side of AI Ingenuity." https://deepmind.google/discover/blog/specification-gaming-the-flip-side-of-ai-ingenuity/
